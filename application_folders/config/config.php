...
|
*/
$config['base_url']	= 'http://'.$_SERVER['HTTP_HOST'];//設定網址
...
|
*/
$config['language']	= 'taiwan';//english
...
|
*/
$config['cache_path'] = '';//默認的緩存目錄（system/cache/）來存儲緩存
...
|
*/
$config['encryption_key'] = '13432';//使用的密鑰
...
|
*/
$config['global_xss_filtering'] = false;//是否對輸入數據（GET、POST）自動過濾跨腳本攻擊
...
|
*/
$config['time_reference'] = 'local';//設置時間格式："local"、"GMT"
